...
class HomePageView extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  int _actValue; // store the actual value during calculation
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                _toggled ? "1:00" : "...",
                style: TextStyle(
                    fontWeight: FontWeight.bold, height: 5, fontSize: 40),
                textAlign: TextAlign.center,
              ),
            ),
            Container(
              ...
              child: Text(
                _toggled
                    ? "Prstem zakryjte současně kameru a blesk kamery ☝"
                    : "Pro zahájení měření tapněte na ikonu ♥",
                style: TextStyle(
